...
\begin{equation}
    \begin{aligned}
       ...
       &=\frac{(\sum_{i}\left(\hat{y}_{i}-\bar{y}\right)^2)^2}{\sum_{i}\left(\hat{y}_{i}-\bar{y}\right)^{2}\sum_{i}\left(y_{i}-\bar{y}\right)^{2}}=\frac{\sum_{i}\left(\hat{y}_{i}-ar{y}
       ight)^{2}}{\sum_{i}\left(y_{i}-ar{y}
       ight)^{2}}
    \end{aligned}
    \nonumber
\end{equation}
