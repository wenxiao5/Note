...
\begin{equation}
    \begin{array}{cccc}
        \hline \text { Source } & \text { SS } & \text { df } & \text { MS } & F \\
        \hline \hline \\
        \begin{array}{c}
        \text { Regression } \\
        \text { (model) }
        \end{array} & \text { FSS } \quad 1 & \text { MSReg }=\frac{F S S}{1} & F=\frac{M S R e g}{M S E} \\
        \text { Error } & \text { RSS } \quad n-2 \quad M S E=\frac{R S S}{n-2} & \\
