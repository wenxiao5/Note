...
\subsubsection{Estimation (always reported for a parameter: $\hat{\beta}_0+\hat{\beta}_1x^*=\mathbb{E}(Y|x^*)$)}
...
\subsubsection{Prediction Interval for $y^*=(x^*)^T\beta+\varepsilon$}
