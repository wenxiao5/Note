...
$$t_i\sim T_{n-p-1}$$
We can use t-test to test the $i^{th}$ observation.\\
...
Outliers, as well as other unusual observations discussed here, often ﬂag potential problems of the current model. Instead of dropping them, maybe, try a new alternative model.
