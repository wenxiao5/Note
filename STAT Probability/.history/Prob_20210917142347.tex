...
\subsection{推导}
我们考虑一段时间，每一刻(瞬间)都有一个event may occur, which follows binomial distribution $B(n,p)$. where $n \rightarrow \infty, p \rightarrow 0$; $\lambda=n\codt p$ is the expected number of events in this period of time.
