...
\begin{enumerate}[$\bullet$]
    ...
    \item \underline{Averaging}: $\bar{X}_n=\frac{1}{n}\sum_{i=1}^nX_i=\frac{X_n}{n}+\bar{X}_{n-1}\frac{n-1}{n}$.(nicer graph) (The benefits of this smoothing operation are mostly seen in the initial stages of the SA recursion, and do not improve the
    convergence rate.)
\end{enumerate}
