...
However, the weighted sum $z=x^TW=\sum_{i=1}^mw_ix_i+b$ ranges $-\infty$ to $\infty$. We want to force the $z$ to be a legal probability, that is, to lie between $0$ and $1$.
