...
\begin{equation}
    ...
    \nonumber
\end{equation}
The risk of the optimal rule $\delta^*=w^*x$ is $R(\delta^*)$ and the empirical risk under rule $\hat{\delta}(x)=\hat{w}x$ is $R(\hat{\delta}(x))$. $R(\hat{\delta}(x))>R(\delta^*)$ always holds, and $$R(\hat{\delta}(x))\rightarrow R(\delta^*)\text{ as }n \rightarrow \infty$$
