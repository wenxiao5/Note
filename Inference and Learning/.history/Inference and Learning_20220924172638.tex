...
\begin{definition}
    \textit{Parameters} are values learned by the model given the data. e.g. $\beta, W, b, \theta$.
\end{definition}
\begin{definition}
    \textit{Hyperparameters} are values supplied to tune the model and cannot be learned from data. e.g. Number of Hidden Layers, Neurons, and Epochs to Train. Learning Rate, and Batch Size.
\end{definition}
