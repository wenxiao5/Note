...
\begin{enumerate}[(1)]
    ...
    \begin{equation}
        \begin{aligned}
            \sigma(x)&=\frac{1}{e^{-x}};\ \sigma(-x)&=1-\sigma(x)\\
            \frac{d\sigma(x)}{dx}&=\frac{1}{1+e^{-x}}\left(1-\frac{1}{1+e^{-x}}\right)=\sigma(x)\cdot(1-\sigma(x))
        \end{aligned}
        \nonumber
    \end{equation} $\sigma(x)=\frac{1}{e^{-x}}$; $\frac{d\sigma(x)}{dx}=\frac{1}{1+e^{-x}}\left(1-\frac{1}{1+e^{-x}}\right)=\sigma(x)\cdot(1-\sigma(x))$; $\sigma(-x)=1-\sigma(x)$.
