...
The methods described below can be used to solve the following problems: (1) $\int_X f$; (2) the probability of a subset $a\subset X :P(a)=\int_a p(x)dx$, where $h(x)=\mathbf{1}_{x\in a}$
