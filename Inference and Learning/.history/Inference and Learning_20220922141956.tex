...
Assume $\theta$ is a scalar parameter. Performance: (1) Bias $\mathbb{E}[\hat{\theta}_n(\vec{Y})]=\theta$; (2) Variance $\mathbb{E}[\hat{\theta}_n^2(\vec{Y})]-\mathbb{E}^2[\hat{\theta}_n(\vec{Y})]$
