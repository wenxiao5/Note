...
(1) Bias $\mathbb{E}[\hat{\theta}_n(\vec{Y})]=\theta$; (2) Variance $\mathbb{E}[\hat{\theta}_n^2(\vec{Y})]-\mathbb{E}^2[\hat{\theta}_n(\vec{Y})]$; (3) CDF $G_{n}(t)=P(\hat{\theta}_n(\vec{Y})<t),\forall t$
