...
Universal Approximation Theorem, in its lose form, states that a feed-forward network with a single hidden layer containing a finite number of neurons \textbf{can approximate any continuous function}.
