...
\subsubsection{Limit Theorem for MC with \underline{Regular} transition matrix: limiting distribution is the unique stationary distribution}
...
\subsubsection{Fundamental Theorem for Irreducible, Aperiodic, Finite MC}
\begin{theorem}
    ...
    \begin{enumerate}[(1)]
        \item $\pi$ is the limiting distribution of the MC. ($\lim_{n \rightarrow \infty}\alpha P^n=\pi,\forall \alpha$ initial distribution)
    \end{enumerate}
\end{theorem}
