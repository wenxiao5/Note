...
\begin{enumerate}
    \item[\textbf{{Method} 1}:] Condition on first step: Let $a_j=\mathbb{E}[T_i|X_0=j]$
    \item\textbf{{Method} 2}: This problem can be transformed into computing the \textbf{expected time till absorption to $i$}. (we can let $i$ be an absorbing state)
