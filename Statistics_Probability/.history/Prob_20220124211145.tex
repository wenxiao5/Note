...
$$
\begin{aligned}
&P(|\bar{x}-\mu|>\varepsilon) \leqslant \frac{\sigma^{2}}{n \varepsilon^{2}} \quad\left(\operatorname{Var} \bar{x}=\frac{\sigma^{2}}{n}\right) \\
&\qquad \begin{array}{l}
\sigma^{2} \rightarrow \infty \\
n \Sigma^{2}
\end{array}=0 \\
&\Rightarrow 2.4 .5 \text { also converges to } 0 .
\end{aligned}
$$
