...
$$M_X(t_1,t_2,...,t_k)=\mathbb{E}e^\Omega=e^{\mathbb{E}(\Omega)+\frac{1}{2}Var(\Omega)}=e^{\sum_{i=1}^kt_k \mathbb{E}(x_k)+\frac{1}{2}Var(\sum_{i=1}^k t_ix_i)}$$
\end{proof}
...
\end{theorem}
\begin{proof}
As we show $M_X(t_1,t_2,...,t_k)=e^{\sum_{i=1}^kt_k \mathbb{E}(x_k)+\frac{1}{2}Var(\sum_{i=1}^k t_ix_i)}$. If $Cov(x_i,x_j)=0,\forall i,j\in S$,
\begin{equation}
    \begin{aligned}
        M_X(t_1,t_2,...,t_k)&=e^{\sum_{i=1}^kt_k \mathbb{E}(x_k)+\frac{1}{2}Var(\sum_{i=1}^k t_ix_i)}\\
        &=e^{\sum_{i=1}^kt_k \mathbb{E}(x_k)+\frac{1}{2}\sum_{i=1}^kt_i^2Var(x_i)}
    \end{aligned}
    \nonumber
\end{equation}
\end{proof}
