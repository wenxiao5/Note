...
\subsubsection{Theorem: Finite MC with transition matrix $P$, }
\begin{theorem}
    A finite aperiodic MC with transition matrix $P$, then for some $N\geq 1$ $$P^n_{ii}>0,\quad \forall i,\forall n\geq N$$
\end{theorem}
