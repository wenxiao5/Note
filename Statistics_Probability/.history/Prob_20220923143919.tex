...
\begin{theorem}[Fundamental Theorem for General Discrete Markov Chains]
    ...
    $\pi(x)$ equals to the expected visiting time at $x$ $$\lim_{n \rightarrow \infty}\frac{1}{n}\sum_{k=0}^{n-1}P_{ij}^k=\pi(j)$$
    If in addition, the MC is \textbf{aperiodic}, then $$
\end{theorem}
