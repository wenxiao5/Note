...
\subsubsection{Fundamental Theorem for \underline{Irreducible, Aperiodic, Finite MC} $\Rightarrow$ Regular transition matrix: $\exists$ unique limiting distribution $\pi$ and $\pi_j>0,\forall j$}
\begin{theorem}
