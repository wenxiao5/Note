...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            (\text{let }y=\frac{1}{\sqrt{n}})&=\lim_{y=0}\frac{\log M_0(yt)}{y^2}\\
            (\text{L'Hôpital's rule})&=\lim_{y=0}\frac{t M'_0(yt)}{2y M_0(yt)}\\
            (\text{L'Hôpital's rule})&=\lim_{y=0}\frac{t^2 M''_0(yt)}{2 M_0(yt)+2ytM'(yt)}\\
            &=\frac{t^2}{2}
        \end{aligned}
        \nonumber
    \end{equation}
