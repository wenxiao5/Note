...
\begin{enumerate}[$\bullet$]
    ...
    \begin{lemma}
        There is at least one recurrent state in a Markov Chain.
    \end{lemma}
\end{enumerate}
...
\subsubsection{Regular Matrices}
A matrix $M$ is said to be positive if all the entries of $M$ are positive. We write $M > 0$.
\begin{definition}[Regular Matrices]
    A transition matrix $P$ is said to be regular if some power of $P$ is positive. That is, $P_n >0$, for some $n\geq 1$.
\end{definition}
