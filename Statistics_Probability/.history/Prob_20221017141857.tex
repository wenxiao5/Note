...
\begin{enumerate}
    ...
    \item All binary sequence consisted of $0$ or $1$ of length $d$ and \textbf{no consecutive 1}, $X=\{0,1\}^d$, $|X|=2^d$. $\pi$ is a uniform distribution on all $X$. We can use a MC of tossing a coin to simulate it.
\end{enumerate}
