...
\begin{theorem}
    ...
    Furthermore, for all states $i$, limiting distribution on $i$ equals to the expected proportion of time spends in $i$: $$\pi_j=\lim_{n \rightarrow \infty}\frac{1}{n}\sum_{m=0}^{n-1}P_{ij}^m$$
\end{theorem}
