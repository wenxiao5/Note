...
\begin{proof}
    ...
    Consider this total time is $T_1+T_2+\cdots+T_k$ and the time we spent at $i$ is $k$, the expected proportion of time the chain spends in state $i$ is approximately $\frac{k}{T_1+T_2+\cdots+T_k}=\frac{1}{\mathbb{E}(T|X_0=i)}$
\end{proof}
