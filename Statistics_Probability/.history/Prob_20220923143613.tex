...
\begin{theorem}[Fundamental Theorem for General Discrete Markov Chains]
    An irreducible, positive recurrent MC has a unique stationary distribution $\pi$ (which is positive everywhere) solving the equation
    $$\sum_{y\in S}\pi(y)P(y,x)=\pi(x)$$
\end{theorem}
