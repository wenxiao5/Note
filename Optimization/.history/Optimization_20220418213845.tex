...
\begin{proof}
    ...
    \begin{proof}
        ...
        \begin{equation}
            \begin{aligned}
                f(x)&\leq g(y,z)\quad \forall y\in \mathbb{Y}\\
                \Rightarrow \max_{z\in \mathbb{Z}}f(x)&\leq \max_{z\in \mathbb{Z}}g(y,z)\quad \forall y\in \mathbb{Y}\\
                \Rightarrow \max_{z\in \mathbb{Z}}f(x)&\leq \min_{y\in \mathbb{Y}}\max_{z\in \mathbb{Z}}g(y,z)\\
...
\begin{center}
    \fcolorbox{black}{gray!10}{\parbox{.9\linewidth}{If the optimization problem is a \underline{linear program} and its is feasible, then strong duality holds (always)}}
\end{center}
