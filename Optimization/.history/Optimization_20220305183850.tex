...
\begin{equation}
    \begin{aligned}
        J=\sum_{n=1}^N L(y[n],\bar{y}[n])
    \end{aligned}
    \nonumber
\end{equation}
where $\bar{y}[n]$ is the output of NN whose input is $x[n]$.

$L$ is the function to measure the loss. e.g. the square loss $$L(y,\bar{y})=(y-\bar{y})^2$$
