...
\begin{definition}
Given a set of points $S\subseteq \mathbb{R}^n$, the convex hull $conv(S)$ is the set of all convex combinations of points in $S$.

(Eauivalenties: We can define the $conv(S)$ as the smallest convex set contains $S$)
\end{definition}
