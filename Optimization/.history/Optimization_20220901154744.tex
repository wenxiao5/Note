...
\begin{equation}
    \begin{aligned}
        w^*=\argmin_{w\in \mathbb{R}}\mathbb{E}_P\left[(wX-Y)^2\right]=\frac{\mathbb{E}[XY]}{\mathbb{E}[X^2]}
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \hat{w}=\argmin_{w\in \mathbb{R}}\frac{1}{n}\sum_{i=1}^n\left[(wX-Y)^2\right]=\frac{\mathbb{E}[XY]}{\mathbb{E}[X^2]}
    \end{aligned}
    \nonumber
\end{equation}
