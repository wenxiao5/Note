...
\begin{equation}
    ...
    \nonumber
\end{equation}
Also, $Ax^*=b$. If $m=n$, there will unique $x^*=A^{-1}b$. If $m<n$, we compute first-order condition:
\begin{equation}
    \begin{aligned}
        \left.\begin{matrix}
            A^T\lambda+\nabla f(x^*)&=0\\
    ...
    \nonumber
\end{equation}
Check sufficient conditions (second-order):
\begin{equation}
    \begin{aligned}
