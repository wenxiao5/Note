...
$$(x-y)^T(\nabla f(x)-\nabla f(y))\geq m\|x-y\|\quad \forall x,y\in\&$$
...
\begin{equation}
    \begin{aligned}
        ...
        (m-\text{strong convexity}\Rightarrow	(x_k-x^*)^T(\nabla f(x_k)-\nabla f(x^*))\geq m\|x_k-x^*\|)\quad &\leq \|x_k-x^*\|^2+\alpha^2M^2\|x_k-x^*\|^2-2\alpha m\|x_k-x^*\|\\
    \end{aligned}
    \nonumber
\end{equation}
By strong convexity of $f$
