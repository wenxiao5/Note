...
\begin{definition}
    Let $\&$ be a closed convex subset of $\mathbb{R}^n$. Then, for $\mathfrak{Z}\in \mathbb{R}^n$, the \underline{projection} of $\mathfrak{Z}$ on $\&$ is denoted by $[\mathfrak{Z}]^\&$ and is given by $$[\mathfrak{Z}]^\&=\arg \min_{y\in \&}\|\mathfrak{Z}-y\|^2$$
\end{definition}
