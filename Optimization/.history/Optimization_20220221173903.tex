...
$\lambda_{\min}I\preceq \nabla^2 f(x) \Leftrightarrow$ $\lambda_{\min}$-strongly convex; $\nabla^2 f(x)\preceq \lambda_{\max}I$ is a sufficient condition for $f$ is $\lambda_{\max}$-Lipschitz gradient.
