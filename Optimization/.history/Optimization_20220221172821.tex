...
\end{example}
Let $\lambda_{\min}$ and $\lambda_{\max}$ be the min and max eigenvalue of $Q$. Then we know $$\lambda_{\min}\|\mathfrak{Z}\|^2\leq\mathfrak{Z}^TQ\mathfrak{Z}\leq \lambda_{\max}\|\mathfrak{Z}\|^2\leq \lambda_{\max}\|\mathfrak{Z}\|^2$$
