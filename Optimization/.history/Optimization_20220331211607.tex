...
\end{example}
Let $\lambda_{\min}$ and $\lambda_{\max}$ be the min and max eigenvalue of $Q$. Then we know $$\lambda_{\min}\|z\|^2\leqz^TQz\leq \lambda_{\max}\|z\|^2$$
...
\end{definition}
\underline{Result}: If $f$ has $L-$Lipschitz gradient and $0<\alpha<\frac{2}{L}$
