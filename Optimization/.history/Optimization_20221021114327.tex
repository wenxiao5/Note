...
\begin{center}
    \fcolorbox{black}{blue!10}{\parbox{.9\linewidth}{\begin{theorem}[Karush-Kuhn-Tucker theorem, saddle point form]
        ...
        \begin{enumerate}[(1)]
            ...
            \item $L(\vec{x}^*,\vec{\lambda}^*)\geq L(\vec{x}^*,\vec{\lambda})$ for all $\vec{\lambda}\in \vec{0}$. (maximality of $\vec{\lambda}^*$)
...
\begin{proof}\quad
    \begin{enumerate}[$\bullet$]
        \item $(\Rightarrow):$ Assume $\vec{x}^*$ is an optimal solution of $P$ and $\vec{\lambda}^*$ is a sensitivity vector. Take $\vec{x}\in S$, then
        \begin{equation}
            \begin{aligned}
        ...
        \begin{equation}
            ...
            \nonumber
        \end{equation}
        If we set $\vec{x}=\vec{x}^*$,
        \begin{equation}
            \begin{aligned}
                \vec{\lambda}^*\cdot \vec{g}(\vec{x}^*)\geq 0
            \end{aligned}
            \nonumber
        \end{equation}
        \item 
