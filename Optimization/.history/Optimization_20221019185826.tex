...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
            ...
            \vec{a}\cdot \vec{x}^*+ b f(\vec{x}^*)\geq \vec{a}\cdot \vec{x}+ by
        \end{aligned}
        \nonumber
    \end{equation}
    $$(\vec{a},b)\cdot \left(\vec{x}^*,f(\vec{x}^*)\right)\geq (\vec{a},b)\cdot \left(\vec{x},y\right),\ \forall \left(\vec{x},y\right)\in epi(f)$$
