...
\begin{equation}
    \begin{aligned}
        ...
        &=H_k^{-1}+y_k^T s_k(y_ky_k^T)^{-1}-s_k^TH_ks_k(H_k s_ks_k^TH_k)^{-1}\\
        &=H_k^{-1}+y_k^T s_k\\
        &\\
        &\\
        &\\
        &=\left(I-\frac{s_ky_k^T}{y^T_ks_k}\right)H_k^{-1}\left(I-\frac{y_ks_k^T}{y^T_ks_k}\right)+{s_ks_k^T}{y^T_ks_k}
    \end{aligned}
    \nonumber
\end{equation}
