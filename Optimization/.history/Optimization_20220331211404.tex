...
\subsubsection{Def: Projection $[\mathfrak{Z}]^\&$}
\begin{definition}
    Let $\&$ be a \underline{closed convex} subset of $\mathbb{R}^n$. Then, for $\mathfrak{Z}\in \mathbb{R}^n$, the \underline{projection} of $\mathfrak{Z}$ on $\&$ is denoted by $[\mathfrak{Z}]^\&$ and is given by
    $$[\mathfrak{Z}]^\&=\arg \min_{y\in \&}\|\mathfrak{Z}-y\|^2$$
\end{definition}
i.e. Find the min distance from $\&$ to $\mathfrak{Z}$
\begin{center}\begin{figure}[htbp]
    \centering
    ...
    \label{}
\end{figure}\end{center}
\textbf{Note:} $[\mathfrak{Z}]^\&$ exists and is unique in convex $\&$, however, when $\&$ is not convex, $[\mathfrak{Z}]^\&$ may not be unique.
\begin{center}\begin{figure}[htbp]
    \centering
...
\begin{proposition}
    ...
    Let $\&$ be a \underline{closed convex} subset of $\mathbb{R}^n$. Then, for every $\mathfrak{Z}\in \mathbb{R}^n$, there exists a unique $[\mathfrak{Z}]^\&$.
\end{proposition}
\begin{proof}
Nee to show that $\min_{y\in \&}\|\mathfrak{Z}-y\|^2$ exists and is unique.

Let $x$ be some element of $\&$. Then
\begin{equation}
    \begin{aligned}
        &\text{minimizing $\|\mathfrak{Z}-y\|^2$ over all $y\in\&$}\\
        \equiv&\text{minimizing $\|\mathfrak{Z}-y\|^2$ over the set $A=\{y\in\&:\|\mathfrak{Z}-y\|^2\}$}
    \end{aligned}
    \nonumber
\end{equation}
$g(y)=\|\mathfrak{Z}-y\|^2$ is strictly convex on set $\&$ $\Rightarrow$ $A$ is a convex set and $g$ is convex on $A$.

Also $g$ is continuous $\Rightarrow	A$ is closed.

Finally, $y\in A \Rightarrow \|y\|^2=\|y-\mathfrak{Z}+\mathfrak{Z}\|^2\leq \|y-\mathfrak{Z}\|^2+\|\mathfrak{Z}\|^2\leq \|\mathfrak{Z}-x\|^2+\|\mathfrak{Z}\|^2 \Rightarrow A$ is bounded.

Thus, $g(y)=\|\mathfrak{Z}-y\|^2$ is strictly convex over set $A$, which is compact.
...
\begin{proposition}
    ...
    \begin{equation}
        \begin{aligned}
            [\mathfrak{Z}]^\&=y^*
            &\Leftrightarrow (y^*-\mathfrak{Z})^T(y-y^*)\geq 0,\quad \forall y\in\&.\\
            &\Leftrightarrow (\mathfrak{Z}-y^*)^T(y-y^*)\leq 0,\quad \forall y\in\&.
        \end{aligned}
        \nonumber
    \end{equation}
\end{proposition}
\begin{proof}
    $[\mathfrak{Z}]^\& = \argmin_{y\in\&}g(y)$, with $g(y)=\|\mathfrak{Z}-y\|^2$ (which is strictly convex), $\nabla g(y)=2(y-\mathfrak{Z})$.
...
\begin{proposition}
    ...
    Let $\&$ be a \underline{closed convex} subset of $\mathbb{R}^n$. Then for $x,\mathfrak{Z}\in \mathbb{R}^n$
    $$\|[x]^\&-[\mathfrak{Z}]^\&\|\leq \|x-\mathfrak{Z}\|\quad \forall x,\mathfrak{Z}\in \mathbb{R}^n$$
\end{proposition}
\begin{proof}
...
\begin{equation}
    \begin{aligned}
        ...
        (2).\quad ([\mathfrak{Z}]^\&-\mathfrak{Z})^T(y-[\mathfrak{Z}]^\&)\geq 0,\quad \forall y\in\&.\\
    \end{aligned}
    \nonumber
\end{equation}
set $y=[\mathfrak{Z}]^\&$ in (1) and $y=[x]^\&$ in (2), and adding,
\begin{equation}
    \begin{aligned}
        &([\mathfrak{Z}]^\&-[x]^\&)^T([x]^\&-x+\mathfrak{Z}-[\mathfrak{Z}]^\&)\geq 0\\
        \Rightarrow	& ([\mathfrak{Z}]^\&-[x]^\&)^T(\mathfrak{Z}-x)\geq \|[\mathfrak{Z}]^\&-[x]^\&\|^2
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \|[\mathfrak{Z}]^\&-[x]^\&\|^2&\leq \|[\mathfrak{Z}]^\&-[x]^\&\|\|\mathfrak{Z}-x\|\\
        \|[\mathfrak{Z}]^\&-[x]^\&\|&\leq \|\mathfrak{Z}-x\|
    \end{aligned}
    \nonumber
\end{equation}
\end{proof}
...
\subsubsection{Orthogonality Principle in subspaces of $\mathbb{R}^n$: $(\mathfrak{Z}-y^*)^Tx= 0,\forall x\in\&$}
...
Then, for $\mathfrak{Z}\in \mathbb{R}^n$, $[\mathfrak{Z}]^\&=y^*$ satisfies:
\begin{equation}
    \begin{aligned}
        (\mathfrak{Z}-y^*)^T(y-y^*)\leq 0,\quad \forall y\in\&.
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        (\mathfrak{Z}-y^*)^Tx\leq 0,\quad \forall x\in\&.
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        (\mathfrak{Z}-y^*)^Tx\geq 0,\quad \forall x\in\&.
    \end{aligned}
    \nonumber
\end{equation}
...
\begin{equation}
    \begin{aligned}
        (\mathfrak{Z}-y^*)^Tx= 0,\quad \forall x\in\&.
    \end{aligned}
    \nonumber
\end{equation}
...
\end{equation}
\begin{definition}
    $\tilde{x}$ is a fixed (stationary) point of iteration in (1) if $$\tilde{x}=[\tilde{x}-\alpha \nabla f(\tilde{x})]^\&$$
\end{definition}
