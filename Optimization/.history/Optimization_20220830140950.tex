...
\subsubsection*{Binary hypothesis testing (detection) when $S=\{0,1\}$}
\text{Example:} $P_0\sim N(0,\sigma^2), P_1\sim N(\mu,\sigma^2)$

\subsubsection*{Multiple hypothesis testing (classification) when $S=\{1,2,...,n\}$}
