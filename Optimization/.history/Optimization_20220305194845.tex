...
\begin{center}\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.3]{MNN.png}
...
For large $M$, recall $y^{(M)}=\sigma(x^{(M)})$, $x^{(M)}=W^{(M)}y^{(M-1)}+b^{(M)}$
\begin{equation}
    \begin{aligned}
        \frac{\partial L}{\partial w_{ij}^{(M)}}=\frac{\partial L}{\partial y_i^{(M)}}\cdot \frac{\partial y_i^{(M)}}{\partial w_{ij}^{(M)}}=\frac{\partial L}{\partial y_i^{(M)}}\cdot \frac{\partial y_i^{(M)}}{\partial x_{ij}^{(M)}}\cdot \frac{\partial x_{ij}^{(M)}}{\partial w_{ij}^{(M)}}
    \end{aligned}
    \nonumber
\end{equation}
