...
\begin{equation}
    \begin{aligned}
        f(y)-f(x)-\nabla^T f(x)(y-x)&\geq \frac{m}{2}\|x-y\|^2\\
        f(x)-f(y)-\nabla^T f(y)(x-y)&\geq \frac{m}{2}\|x-y\|^2\\
        \Rightarrow	(\nabla^T f(x)-\nabla^T f(y))(x-y)&\geq m\|x-y\|^2\\
        f(y)-f(x)-\nabla^T f(x)(y-x)&\leq \frac{L}{2}\|x-y\|^2\\
        f(x)-f(y)-\nabla^T f(y)(x-y)&\leq \frac{L}{2}\|x-y\|^2\\
        \Rightarrow	(\nabla^T f(x)-\nabla^T f(y))(x-y)&\leq L\|x-y\|^2
    \end{aligned}
    \nonumber
\end{equation}
