...
\end{corollary}
\begin{proof}
$F(x)=f(x)-mx^2=|x|^p-\frac{m}{2}x^2$. $g_1(x)=|x|,x\in \mathbb{R}^n$ is convex; $g_2(x)=x^p-\frac{m}{2}x^2,x\in \mathbb{R}^+\cup\{0\}$ is also convex since $g_2(y)+(x-y)g_2^{'}(y)=y^p-\frac{m}{2}y^2+(x-y)[px^{p-1}-mx]$
\end{proof}
