...
\begin{enumerate}[$\bullet$]
    ...
    \begin{equation}
        ...
        \nonumber
    \end{equation}
    \item But Newton's method has several drawbacks:
    \begin{enumerate}[(1)]
        \item Newton’s method requires the matrix inversion step, and this is quite expensive. So the per step cost for Newton’s method is higher.
        \item Newton’s method has faster local convergence but may diverge if initialized from some place far from the optimal point.
