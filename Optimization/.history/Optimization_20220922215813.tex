...
\begin{equation}
    \begin{aligned}
        \frac{{Term}_1(\vec{t})}{\delta^*_1}=\frac{{Term}_2(\vec{t})}{\delta^*_2}=\cdots=\frac{{Term}_m(\vec{t})}{\delta^*_m}=V(\vec{\delta}^*) \triangleq \frac{1}{n}\sum_{i=1}^n\delta_{i}^*
    \end{aligned}
    \nonumber
\end{equation}
where $V(\vec{\delta}^*)$ is defined as the \textbf{mean} of $\vec{\delta}^*$
...
\begin{proof}
    ...
    Suppose there exists another solution $\vec{t}'$ to the primal problem. Because 
\end{proof}
