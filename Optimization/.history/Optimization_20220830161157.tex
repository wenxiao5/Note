...
\begin{definition}
    Given a point $\overrightarrow{x}\in \mathbb{R}^n$ and a direction vector $ \overrightarrow{u}\neq 0, \in \mathbb{R}^n$, the line through $\overrightarrow{x}$ in the direction of $\overrightarrow{u}$ is $\{\overrightarrow{x}+t \overrightarrow{u}: t\in \mathbb{R}\}$
\end{definition}
