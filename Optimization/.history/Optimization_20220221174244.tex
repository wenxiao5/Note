...
\subsubsection{Definition: $m$-strongly convex $\Leftrightarrow$ $\nabla^2 f(x)\succeq mI$}
\begin{definition}
...
$\lambda_{\min}I\preceq \nabla^2 f(x) \Leftrightarrow$ $f$ is $\lambda_{\min}$-strongly convex; $\nabla^2 f(x)\preceq \lambda_{\max}I$ is a sufficient condition for $f$ has $\lambda_{\max}$-Lipschitz gradient.

The condition number $=\frac{\lambda_{\max}}{\lambda_{\min}}$

\textbf{Special Case:} $Q=\mu I,\quad \mu>0$
$$\lambda_{\min}=\lambda_{\max}=\mu=m=M$$
