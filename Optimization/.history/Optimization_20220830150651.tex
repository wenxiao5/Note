...
\subsubsection*{$S=\mathbb{R}$}
$\max_{\theta\in \mathbb{R}}\sum_{i=1}^n\ln P_\theta(x_i) \Leftrightarrow \max_{\theta\in \mathbb{R}} \left[cn-\frac{\sum_{i=1}^n(x_i-\theta)^2}{2\sigma^2}\right]\Leftrightarrow \max_{\theta\in \mathbb{R}} \sum_{i=1}^n(x_i-\theta)^2 \Rightarrow \hat{\theta}=\bar{x}$
