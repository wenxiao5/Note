...
When solving the closest point problem for a vector space $S$, we use \textbf{perpendicularity condition} (orthogonality condition) -i.e., that $\vec{x}^*\cdot \vec{y},\forall \vec{y}\in S$
