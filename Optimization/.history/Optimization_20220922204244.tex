...
\subsubsection{ Def: posynomial term}
\begin{definition}
    A \textbf{posynomial term} in variables $t_1,...,t_m$ is a function of the form $Ct_1^{\alpha_1}t_2^{\alpha_2}\cdots t_m^{\alpha_m}$
\end{definition}
$$\min_{(t_1,\cdots,t_m}\in \mathbb{R}^m_{>0}g(t_1,\cdots,t_m)$$
where $g(t_1,\cdots,t_m)$ is a sum of posynomial terms. $g(t_1,\cdots,t_m)=\sum_{i=1}^n{Term}_i(t_1,\cdots,t_m)$
