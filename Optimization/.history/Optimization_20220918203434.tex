...
\begin{equation}
    \begin{aligned}
        ...
        \log(1-\frac{m^2}{M^2})\text{ and $\log \frac{1}{\varepsilon}$ is negative, we can't directly take $\log$ on both sides}\\
        (1-\frac{m^2}{M^2})^N\sim \varepsilon
    \end{aligned}
    \nonumber
\end{equation}
