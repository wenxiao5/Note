...
\begin{equation}
    \begin{aligned}
        ...
        \Rightarrow	\frac{\partial f(y)}{\partial x_i}&=\frac{\partial f(x)}{\partial x_i}+\int_0^1\sum_{j=1}^n \frac{\partial^2 f(x+s(y-x))}{\partial x_i\partial x_j}ds\\
        \nabla f(y)&=\nabla f(x)+\int_0^1\sum_{j=1}^n \nabla^2 f(x+s(y-x))(y-x)ds
    \end{aligned}
    \nonumber
\end{equation}
\end{proof}
